...
impl TokenizerWrapper {
    ...
    pub fn from_file(path: &str) -> Result<Self, AppError> {
        ...
        let tokenizer = Tokenizer::from_file(path)
            .map_err(|e| AppError::TokenizationError(format!(
...
mod tests {
    ...
    // Note: These tests require network access to download the tokenizer
    // In a real CI/CD environment, you might want to cache the tokenizer
